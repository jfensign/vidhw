...
class App {
  ...
  const APP_NAME = "micro_api_builder/";
  const APP_PATH = "http://localhost:8080/micro_api_builder/";
  ...
  public static function setLocals($vars) {
   if(is_array($vars)):
   	 self::$Locals = $vars;
   	return;
   else:
   	throw new Exception(__FUNCTION__ . "Expects an array as its first argument.");
   endif;
  }
